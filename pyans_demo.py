...
# setup new database, if it does not yet, otherwise loaded existing
...
# retrieve missing data (downloaded exercises/submissions takes a while)
...
# since data is a Pandas dataframe you can export
